...
${OBJECTDIR}/_ext/1472/MyLogger.o: ../MyLogger.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1472/MyLogger.o ../MyLogger.cpp

${OBJECTDIR}/_ext/1472/MyString.o: ../MyString.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1472
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1472/MyString.o ../MyString.cpp

${OBJECTDIR}/_ext/1472/TestLogic.o: ../TestLogic.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1472
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1472/TestLogic.o ../TestLogic.cpp

${OBJECTDIR}/_ext/1472/Tiger.o: ../Tiger.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1472
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1472/Tiger.o ../Tiger.cpp
...
${OBJECTDIR}/_ext/1472/my_utilities.o: ../my_utilities.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1472
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1472/my_utilities.o ../my_utilities.cpp

${OBJECTDIR}/_ext/1472/reversal.o: ../reversal.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1472
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1472/reversal.o ../reversal.cpp
